...
render_page_header(
    ...
    "Process & Risk Control: a lightweight control layer to map business processes, identify risk points, assign owners, and track records.",
)

st.caption(
    "This page does not replace the existing Sales, Operation, Order Details or Supplier modules. "
    "It maps existing system data into process controls, risk points, responsibilities, templates and history records. "
    "QP-01 RFQ Requirement Control is now usable: RFQ templates can be imported through Import Center and displayed here."
)
...
def _render_overview() -> None:
    ...
    st.success("QP-01 RFQ Requirement Control is connected for import and display. Other processes remain read-only design views. Core Sales / Operation business logic is unchanged.")
    st.markdown(
        ...
        "- AI-assisted summaries and impact assessments are design-ready but not connected, so there is no automatic AI cost."
    )
