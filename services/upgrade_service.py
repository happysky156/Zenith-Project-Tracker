...
INDEX_SNAPSHOT_FIELDS = (
    ...
    FieldSpec("index_code", "Index Code", "Locked index code."),
    FieldSpec("index_category", "Index Category", "FX / Metal / Plastic / Freight."),
    FieldSpec("index_display_name", "Index Display Name", "Locked index display name."),
    FieldSpec("snapshot_value", "Snapshot Value", "Locked index value.", numeric=True),
    FieldSpec("snapshot_unit", "Snapshot Unit", "Locked index unit."),
    FieldSpec("snapshot_source_status", "Snapshot Source Status", "Fetch status at lock time."),
...
INDEX_ALERT_RULE_FIELDS = (
    FieldSpec("alert_rule_id", "Alert Rule ID", "System-generated alert rule ID."),
    FieldSpec("index_code", "Index Code", "Index code, for example USD_CNY or PP.", True),
    FieldSpec("index_name", "Index Name", "Display index name."),
    FieldSpec("index_category", "Index Category", "FX / Metal / Plastic / Freight."),
    FieldSpec("alert_type", "Alert Type", "Daily Change / Fixed Baseline / Snapshot Deviation.", True),
    FieldSpec("direction", "Direction", "Up / Down / Both."),
    FieldSpec("medium_threshold_percent", "Medium Threshold %", "Medium review threshold percentage.", numeric=True),
    FieldSpec("high_threshold_percent", "High Threshold %", "High review threshold percentage.", numeric=True),
    FieldSpec("baseline_value", "Baseline Value", "Manual baseline value for Fixed Baseline alerts.", numeric=True),
    FieldSpec("active", "Active", "Whether this alert rule is active.", boolean=True),
    FieldSpec("remarks", "Remarks", "Free text notes."),
    FieldSpec("created_at", "Created At", "Created timestamp."),
    FieldSpec("created_by", "Created By", "Created by."),
    FieldSpec("updated_at", "Updated At", "Updated timestamp."),
    FieldSpec("updated_by", "Updated By", "Updated by."),
)

INDEX_ALERT_EVENT_FIELDS = (
    FieldSpec("alert_event_id", "Alert Event ID", "System-generated alert event ID."),
    FieldSpec("alert_date", "Alert Date", "Alert trigger date.", True),
    FieldSpec("alert_type", "Alert Type", "Daily Change / Fixed Baseline / Snapshot Deviation.", True),
    FieldSpec("index_code", "Index Code", "Index code.", True),
    FieldSpec("index_name", "Index Name", "Index display name."),
    FieldSpec("index_category", "Index Category", "FX / Metal / Plastic / Freight."),
    FieldSpec("alert_level", "Alert Level", "Medium / High."),
    FieldSpec("direction", "Direction", "Up / Down."),
    FieldSpec("reference_value", "Reference Value", "Previous / baseline / snapshot value.", numeric=True),
    FieldSpec("latest_value", "Latest Value", "Latest index value.", numeric=True),
    FieldSpec("change_value", "Change Value", "Latest value minus reference value.", numeric=True),
    FieldSpec("change_percent", "Change Percent", "Change percentage versus reference value.", numeric=True),
    FieldSpec("related_project_id", "Related Project ID", "Project affected by snapshot deviation."),
    FieldSpec("related_client_quote_id", "Related Client Quote ID", "Client quotation affected."),
    FieldSpec("related_quote_version", "Related Quote Version", "Quotation version affected."),
    FieldSpec("related_snapshot_id", "Related Snapshot ID", "Locked index snapshot ID."),
    FieldSpec("alert_status", "Alert Status", "New / Reviewed / Closed."),
    FieldSpec("review_note", "Review Note", "Manual review note."),
    FieldSpec("created_at", "Created At", "Created timestamp."),
    FieldSpec("created_by", "Created By", "Created by."),
    FieldSpec("reviewed_at", "Reviewed At", "Reviewed timestamp."),
    FieldSpec("reviewed_by", "Reviewed By", "Reviewed by."),
    FieldSpec("source_note", "Source Note", "Alert source note."),
)
...
MODULES: dict[str, ModuleSpec] = {
    ...
    "Index Alert Rules": ModuleSpec("Index Alert Rules", "index_alert_rules", "alert_rule_id", ("alert_rule_id",), INDEX_ALERT_RULE_FIELDS, "Index Alert Rules", "User-maintained index review thresholds."),
    "Index Alert Events": ModuleSpec("Index Alert Events", "index_alert_events", "alert_event_id", ("alert_event_id",), INDEX_ALERT_EVENT_FIELDS, "Index Alert Events", "Generated index movement and quotation snapshot alerts."),
