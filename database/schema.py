...
EXTENSION_TABLE_SQL = [
    ...
    CREATE TABLE IF NOT EXISTS index_snapshots (
        ...
        index_code TEXT,
        index_category TEXT,
        index_display_name TEXT,
        snapshot_value REAL,
        snapshot_unit TEXT,
        snapshot_source_status TEXT,
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS index_alert_rules (
        ...
        direction TEXT,
        medium_threshold_percent REAL,
        high_threshold_percent REAL,
        baseline_value REAL,
        active INTEGER,
        remarks TEXT,
        created_at TEXT,
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS index_alert_events (
        ...
        related_client_quote_id TEXT,
        related_quote_version TEXT,
    ...
    """
    CREATE TABLE IF NOT EXISTS rfq_requirement_control (
        ...
        rfq_working_file_link TEXT,
        customer_original_request_link TEXT,
        sourcing_link TEXT,
        sampling_link TEXT,
        design_file_link TEXT,
        quotation_to_client_link TEXT,
        original_requirement_notes TEXT,
        rfq_received_date TEXT,
        rfq_received_by TEXT,
        drawing_received TEXT,
        specification_received TEXT,
        quantity_confirmed TEXT,
        target_price_received TEXT,
        ...
        quality_compliance_risk TEXT,
        commercial_business_risk TEXT,
        harley_review_status TEXT,
        maria_review_status TEXT,
        current_owner TEXT,
        next_step TEXT,
        due_date TEXT,
        risk_level TEXT,
        ehab_final_decision TEXT,
        rfq_gate_status TEXT,
        source_file TEXT,
        created_at TEXT,
        created_by TEXT,
        last_updated_at TEXT,
...
EXTENSION_INDEX_DEFINITIONS = [
    ("rfq_requirement_control", "idx_rfq_control_project", ["project_id"]),
    ("rfq_requirement_control", "idx_rfq_control_customer", ["customer"]),
    ("rfq_requirement_control", "idx_rfq_control_status", ["rfq_gate_status"]),
    ...
    ("supplier_price_comparisons", "idx_supplier_price_project_rfq_option", ["project_id", "rfq_item_ref", "item_option"]),
    ("price_comparison_decisions", "idx_price_comp_decision_project", ["project_id", "rfq_item_ref", "item_option"]),
    ...
    ("index_alert_rules", "idx_index_alert_rules_code_type", ["index_code", "alert_type"]),
    ("index_alert_events", "idx_index_alert_events_project", ["related_project_id", "alert_status"]),
    ("index_alert_events", "idx_index_alert_events_date", ["alert_date", "alert_level"]),
]
